...
%%old	parse_time(general, [H1,H2,M1,M2,S1,S2])
%%old			when ?is_num(H1), ?is_num(H2), ?is_num(M1), ?is_num(M2), ?is_num(S1), ?is_num(S2) ->
%%old		{
%%old		 {
%%old			 ( H1 - $0 ) * 10 + H2 - $0,
%%old			 ( M1 - $0 ) * 10 + M2 - $0,
...
%%old		 0
%%old		};
%%old	parse_time(general_extended, [H1,H2,$:,M1,M2,$:,S1,S2])
%%old			when ?is_num(H1), ?is_num(H2), ?is_num(M1), ?is_num(M2), ?is_num(S1), ?is_num(S2) ->
%%old		parse_time(general, [H1,H2,M1,M2,S1,S2]);
%%old	parse_time(general_minute, [H1,H2,M1,M2])
%%old			when ?is_num(H1), ?is_num(H2), ?is_num(M1), ?is_num(M2) ->
%%old		parse_time(general, [H1,H2,M1,M2,$0,$0]);
%%old	parse_time(general_minute_extended, [H1,H2,$:,M1,M2])
%%old			when ?is_num(H1), ?is_num(H2), ?is_num(M1), ?is_num(M2) ->
%%old		parse_time(general, [H1,H2,M1,M2,$0,$0]);
%%old	parse_time(general_hour, [H1,H2])
%%old			when ?is_num(H1), ?is_num(H2) ->
%%old		parse_time(general, [H1,H2,$0,$0,$0,$0]);
%%old	parse_time(general_frac, [H1,H2,M1,M2,S1,S2,$,,F1|Frac])
%%old			when ?is_num(H1), ?is_num(H2), ?is_num(M1), ?is_num(M2), ?is_num(S1), ?is_num(S2) ->
%%old		prepare_frac_time(
%%old			 ( H1 - $0 ) * 36000  + ( H2 - $0 ) * 3600 +
%%old			 ( M1 - $0 ) * 600 + ( M2 - $0 ) * 60 +
%%old			 ( S1 - $0 ) * 10 + S2 - $0 ,
%%old			[F1|Frac], 
%%old			1);
%%old	parse_time(general_extended_frac, [H1,H2,$:,M1,M2,$:,S1,S2,$,,F1|Frac])
%%old			when ?is_num(H1), ?is_num(H2), ?is_num(M1), ?is_num(M2), ?is_num(S1), ?is_num(S2) ->
%%old		parse_time(general_frac, [H1,H2,M1,M2,S1,S2,$,,F1|Frac]);
%%old	parse_time(general_minute_frac, [H1,H2,M1,M2,$,, F1|Frac])
%%old			when ?is_num(H1), ?is_num(H2), ?is_num(M1), ?is_num(M2) ->
%%old		prepare_frac_time(
%%old			 ( H1 - $0 ) * 36000  + ( H2 - $0 ) * 3600 +
%%old			 ( M1 - $0 ) * 600 + ( M2 - $0 ) * 60,
%%old			[F1|Frac], 
%%old			60);
%%old	parse_time(general_minute_extended_frac, [H1,H2,$:,M1,M2,$,,F1|Frac])
%%old			when ?is_num(H1), ?is_num(H2), ?is_num(M1), ?is_num(M2) ->
%%old		parse_time(general_minute_frac, [H1,H2,M1,M2,$,, F1|Frac]);
%%old	parse_time(general_hour_frac, [H1,H2,$,,F1|Frac])
%%old			when ?is_num(H1), ?is_num(H2) ->
%%old		prepare_frac_time(
%%old			 ( H1 - $0 ) * 36000  + ( H2 - $0 ) * 3600,
%%old			[F1|Frac], 
%%old			3600);
%%old	
%%old	parse_time(designed_general, [$T,H1,H2,M1,M2,S1,S2])
%%old			when ?is_num(H1), ?is_num(H2), ?is_num(M1), ?is_num(M2), ?is_num(S1), ?is_num(S2) ->
%%old		parse_time(general, [H1,H2,M1,M2,S1,S2]);
%%old	parse_time(designed_general_extended, [$T,H1,H2,$:,M1,M2,$:,S1,S2])
%%old			when ?is_num(H1), ?is_num(H2), ?is_num(M1), ?is_num(M2), ?is_num(S1), ?is_num(S2) ->
%%old		parse_time(general_extended, [H1,H2,$:,M1,M2,$:,S1,S2]);
%%old	parse_time(designed_general_minute, [$T,H1,H2,M1,M2])
%%old			when ?is_num(H1), ?is_num(H2), ?is_num(M1), ?is_num(M2) ->
%%old		parse_time(general_minute, [H1,H2,M1,M2]);
%%old	parse_time(designed_general_minute_extended, [$T,H1,H2,$:,M1,M2])
%%old			when ?is_num(H1), ?is_num(H2), ?is_num(M1), ?is_num(M2) ->
%%old		parse_time(general_minute_extended, [H1,H2,$:,M1,M2]);
%%old	parse_time(designed_general_hour, [$T,H1,H2])
%%old			when ?is_num(H1), ?is_num(H2) ->
%%old		parse_time(general_hour, [H1,H2]);
%%old	parse_time(designed_general_frac, [$T,H1,H2,M1,M2,S1,S2,$,,F1|Frac])
%%old			when ?is_num(H1), ?is_num(H2), ?is_num(M1), ?is_num(M2), ?is_num(S1), ?is_num(S2) ->
%%old		parse_time(general_frac, [H1,H2,M1,M2,S1,S2,$,,F1|Frac]);
%%old	parse_time(designed_general_extended_frac, [$T,H1,H2,$:,M1,M2,$:,S1,S2,$,,F1|Frac])
%%old			when ?is_num(H1), ?is_num(H2), ?is_num(M1), ?is_num(M2), ?is_num(S1), ?is_num(S2) ->
%%old		parse_time(general_extended_frac, [H1,H2,$:,M1,M2,$:,S1,S2,$,,F1|Frac]);
%%old	parse_time(designed_general_minute_frac, [$T,H1,H2,M1,M2,$,,F1|Frac])
%%old			when ?is_num(H1), ?is_num(H2), ?is_num(M1), ?is_num(M2) ->
%%old		parse_time(general_minute_frac, [H1,H2,M1,M2,$,,F1|Frac]);
%%old	parse_time(designed_general_minute_extended_frac, [$T,H1,H2,$:,M1,M2,$,,F1|Frac])
%%old			when ?is_num(H1), ?is_num(H2), ?is_num(M1), ?is_num(M2) ->
%%old		parse_time(general_minute_extended_frac, [H1,H2,$:,M1,M2,$,,F1|Frac]);
%%old	parse_time(designed_general_hour_frac, [$T,H1,H2,$,,F1|Frac])
%%old			when ?is_num(H1), ?is_num(H2) ->
%%old		parse_time(general_hour_frac, [H1,H2,$,,F1|Frac]);
parse_time("T" ++ Value ) ->
...
%parse_localtime(general_tz, [H1,H2,M1,M2,S1,S2,$Z])
%		when ?is_num(H1), ?is_num(H2), ?is_num(M1), ?is_num(M2), ?is_num(S1), ?is_num(S2) ->
%parse_localtime(general_extended_tz, [H1,H2,$:,M1,M2,$:,S1,S2,$Z])
%		when ?is_num(H1), ?is_num(H2), ?is_num(M1), ?is_num(M2), ?is_num(S1), ?is_num(S2) ->
%parse_localtime(general_minute_tz, [H1,H2,M1,M2,$Z])
%		when ?is_num(H1), ?is_num(H2), ?is_num(M1), ?is_num(M2) ->
%parse_localtime(general_minute_extended_tz, [H1,H2,$:,M1,M2,$Z])
%		when ?is_num(H1), ?is_num(H2), ?is_num(M1), ?is_num(M2) ->
%parse_localtime(general_hour_tz, [H1,H2,$Z])
%		when ?is_num(H1), ?is_num(H2) ->
%parse_localtime(general_frac_tz, [H1,H2,M1,M2,S1,S2,$,,F1|Frac,$Z])
%		when ?is_num(H1), ?is_num(H2), ?is_num(M1), ?is_num(M2), ?is_num(S1), ?is_num(S2) ->
%parse_localtime(general_extended_frac_tz, [H1,H2,$:,M1,M2,$:,S1,S2,$,,F1|Frac,$Z])
%		when ?is_num(H1), ?is_num(H2), ?is_num(M1), ?is_num(M2), ?is_num(S1), ?is_num(S2) ->
%parse_localtime(general_minute_frac_tz, [H1,H2,M1,M2,$,, F1|Frac,$Z])
%		when ?is_num(H1), ?is_num(H2), ?is_num(M1), ?is_num(M2) ->
%parse_localtime(general_minute_extended_frac_tz, [H1,H2,$:,M1,M2,$,,F1|Frac,$Z])
%		when ?is_num(H1), ?is_num(H2), ?is_num(M1), ?is_num(M2) ->
%parse_localtime(general_hour_frac_tz, [H1,H2,$,,F1|Frac,$Z])
%		when ?is_num(H1), ?is_num(H2) ->
%parse_localtime(designed_general, [$T,H1,H2,M1,M2,S1,S2,$Z])
%		when ?is_num(H1), ?is_num(H2), ?is_num(M1), ?is_num(M2), ?is_num(S1), ?is_num(S2) ->
%parse_localtime(designed_general_extended_tz, [$T,H1,H2,$:,M1,M2,$:,S1,S2,$Z])
%		when ?is_num(H1), ?is_num(H2), ?is_num(M1), ?is_num(M2), ?is_num(S1), ?is_num(S2) ->
%parse_localtime(designed_general_minute_tz, [$T,H1,H2,M1,M2,$Z])
%		when ?is_num(H1), ?is_num(H2), ?is_num(M1), ?is_num(M2) ->
%parse_localtime(designed_general_minute_extended_tz, [$T,H1,H2,$:,M1,M2,$Z])
%		when ?is_num(H1), ?is_num(H2), ?is_num(M1), ?is_num(M2) ->
%parse_localtime(designed_general_hour_tz, [$T,H1,H2,$Z])
%		when ?is_num(H1), ?is_num(H2) ->
%parse_localtime(designed_general_frac_tz, [$T,H1,H2,M1,M2,S1,S2,$,,F1|Frac,$Z])
%		when ?is_num(H1), ?is_num(H2), ?is_num(M1), ?is_num(M2), ?is_num(S1), ?is_num(S2) ->
%parse_localtime(designed_general_extended_frac_tz, [$T,H1,H2,$:,M1,M2,$:,S1,S2,$,,F1|Frac,$Z])
%		when ?is_num(H1), ?is_num(H2), ?is_num(M1), ?is_num(M2), ?is_num(S1), ?is_num(S2) ->
%parse_localtime(designed_general_minute_frac_tz, [$T,H1,H2,M1,M2,$,,F1|Frac,$Z])
%		when ?is_num(H1), ?is_num(H2), ?is_num(M1), ?is_num(M2) ->
%parse_localtime(designed_general_minute_extended_frac_tz, [$T,H1,H2,$:,M1,M2,$,,F1|Frac,$Z])
%		when ?is_num(H1), ?is_num(H2), ?is_num(M1), ?is_num(M2) ->
%parse_localtime(designed_general_hour_frac_tz, [$T,H1,H2,$,,F1|Frac,$Z])
%		when ?is_num(H1), ?is_num(H2) ->
