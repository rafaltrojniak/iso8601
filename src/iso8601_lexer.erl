...
-module(iso8601_lexer).

-export([string/1,string/2,token/2,token/3,tokens/2,tokens/3]).
-export([format_error/1]).

%% User code. This is placed here to allow extra attributes.
-file("src/iso8601_lexer.xrl", 16).
...
-file("src/iso8601_lexer.erl", 276).
yystate() -> 7.

yystate(8, Ics, Line, Tlen, _, _) ->
    {4,Tlen,Ics,Line};
yystate(7, [90|Ics], Line, Tlen, Action, Alen) ->
    yystate(5, Ics, Line, Tlen+1, Action, Alen);
yystate(7, [87|Ics], Line, Tlen, Action, Alen) ->
...
-file("src/iso8601_lexer.xrl", 3).
yyaction_0(TokenChars) ->
     { token, { decimal, TokenChars, list_to_integer (TokenChars) } } .

-compile({inline,yyaction_1/1}).
-file("src/iso8601_lexer.xrl", 5).
yyaction_1(TokenChars) ->
     { token, { time_designator, TokenChars, TokenChars } } .

-compile({inline,yyaction_2/1}).
-file("src/iso8601_lexer.xrl", 6).
yyaction_2(TokenChars) ->
     { token, { frac_separator, TokenChars, TokenChars } } .

-compile({inline,yyaction_3/1}).
-file("src/iso8601_lexer.xrl", 7).
yyaction_3(TokenChars) ->
     { token, { time_separator, TokenChars, TokenChars } } .

-compile({inline,yyaction_4/1}).
-file("src/iso8601_lexer.xrl", 8).
yyaction_4(TokenChars) ->
     { token, { plus, TokenChars, TokenChars } } .

-compile({inline,yyaction_5/1}).
-file("src/iso8601_lexer.xrl", 9).
yyaction_5(TokenChars) ->
     { token, { minus, TokenChars, TokenChars } } .

-compile({inline,yyaction_6/1}).
-file("src/iso8601_lexer.xrl", 10).
yyaction_6(TokenChars) ->
     { token, { week_separator, TokenChars, TokenChars } } .

-compile({inline,yyaction_7/1}).
-file("src/iso8601_lexer.xrl", 11).
yyaction_7(TokenChars) ->
     { token, { timezone_utc, TokenChars, TokenChars } } .
